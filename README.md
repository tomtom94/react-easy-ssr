...
You can make a PR Pull Request whenever you want, you just need minimum 2 people to validate your PR in order to merge it on the master branch. You don't even need the administrator to validate your PR.
