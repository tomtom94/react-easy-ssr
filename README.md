...
Let's illustrate this last point with an example : you have 5 million pages to display with 5 React routes, each route render 1 million pages, you just have to open 1 page (by yourself or a crawler the Google robot, Bing robot etc...) and the other 999999 would render perfectly.
